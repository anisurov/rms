			...
			<div class="panel-heading  text-lest">
					...
					<input type="hidden" value="{{ csrf_token() }}" name="_token">
						 ...
						 <div class="form-group{{ $errors->has('event_type') ? ' has-error' : '' }}">
							<label for="event_type" class="col-md-12 control-label" style="padding-bottom:5px">Event Type*</label>
							<div class="col-md-12" style="padding-bottom:20px">
				...
				<div class="form-group{{ $errors->has('dat') ? ' has-error' : '' }}">
							<label for="dat" class="col-md-12 control-label" style="padding-bottom:5px">Event Date</label>
							<div class="col-md-12" style="padding-bottom:20px">
						...
						<div class="form-group{{ $errors->has('time') ? ' has-error' : '' }}">
							<label for="time" class="col-md-12 control-label" style="padding-bottom:5px">Event Time</label>
							<div class="col-md-12" style="padding-bottom:20px">
